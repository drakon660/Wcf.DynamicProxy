...
namespace Labo.ServiceModel.DynamicProxy
{
    public sealed class ServiceMetadataImporter : IServiceMetadataImporter
    {
        ...
        public ServiceMetadataInformation ImportMetadata(Collection<MetadataSection> metadataCollection,
            MetadataImporterSerializerFormatMode formatMode)
        {
        ...
        private static void AddStateForXmlSerializerImport(MetadataImporter importer, CodeCompileUnit codeCompileUnit,
        ...
        private static void AddStateForDataContractSerializerImport(WsdlImporter importer,
            ...
            CodeDomProvider codeDomProvider)
        {
            ...
            for (int i = 0; i < importer.WsdlImportExtensions.Count; i++)
            {
                ...
                DataContractSerializerMessageContractImporter dataContractSerializerMessageContractImporter =
                    importExtension as DataContractSerializerMessageContractImporter;
            
                if (dataContractSerializerMessageContractImporter != null)
                {
                    dataContractSerializerMessageContractImporter.Enabled =
                        formatMode != MetadataImporterSerializerFormatMode.XmlSerializer;
                }
            }
        }
